...
const { getPatientAppointments, getPatientPrescriptions, submitReview, getMyPatientProfile, updatePatientProfile, uploadProfilePhoto } = require('../controllers/patientController');
...
router.post('/profile/photo', protect, authorizeRoles('patient'), upload.single('profilePhoto'), uploadProfilePhoto);
